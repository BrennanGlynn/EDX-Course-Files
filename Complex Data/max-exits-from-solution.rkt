...
;; Room -> String
;; Produces the room that has the highest number of exits
;; If more than one room has the highest amount of exits return the first of those rooms
...
(define (max-exits-from r0)
  ;; todo is (listof Room); a worklist accumulator
  ;; visited is (listof String); context preserving accumulator, names of rooms already visited
  ;; rsf is the room with the most exits
